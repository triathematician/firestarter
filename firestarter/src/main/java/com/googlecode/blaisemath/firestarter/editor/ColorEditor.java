...
public class ColorEditor extends MPanelEditorSupport {
    ...
    private static final Dimension SQ_DIM = new Dimension(15, 15);
    private static final Dimension RGB_DIM = new Dimension(100, 15);
    private static final Dimension CC_DIM = new Dimension(16, 16);
    private static final Insets CC_INSETS = new Insets(0, 0, 0, 0);
    ...
    public void initCustomizer() {
        ...
        JButton colorChooserButton = new JButton(colorIcon);
