 ...
 * Editor for fonts.
 */
public class FontEditor extends MPanelEditorSupport {
    ...
    private JComboBox<Integer> styleCombo;
    ...
    private void initializeComboBoxes() {
        if (fontsLoaded) {
            familyNameCombo = new JComboBox<>(FONTS.toArray(String[]::new));
        } else {
            familyNameCombo = new JComboBox<>(new String[]{"<html><i>Loading fonts...</i>"});
        ...
        styleCombo = new JComboBox<>(new Integer[]{Font.PLAIN, Font.BOLD, Font.ITALIC, Font.BOLD+Font.ITALIC});
        ...
        synchronized(FONTS) {
            ...
            if (newValue != null) {
                SwingUtilities.invokeLater(() -> {
                    familyNameCombo.setModel(new DefaultComboBoxModel<>(FONTS.toArray(String[]::new)));
    ...
    public void paintValue(Graphics g, Rectangle rect) {
        ...
        int pad = (rect.height - fm.getAscent()) / 2;
