...
public class RectangularShapeEditor extends MultiSpinnerSupport<Double> {
    ...
    public static double DEFAULT_STEP_SIZE = 0.1;
    ...
    protected void initSpinnerModels() {
        ...
        spinners[2].setModel(new SpinnerNumberModel((Number) getNewValue(2), 0.0, Double.MAX_VALUE, DEFAULT_STEP_SIZE));
        spinners[3].setModel(new SpinnerNumberModel((Number) getNewValue(3), 0.0, Double.MAX_VALUE, DEFAULT_STEP_SIZE));
    }
